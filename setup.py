...
#  Last modified by David J Turner (turne540@msu.edu) 08/11/2022, 13:26. Copyright (c) The Contributors
...
setup(
    ...
    setup_requires=[],
    install_requires=["scipy==1.23.4", "astroquery==0.4.6", "pandas==1.5.1", "astropy==5.1.1"],
