...
#  Last modified by David J Turner (turne540@msu.edu) 17/05/2023, 11:50. Copyright (c) The Contributors
...
setup(
    ...
    install_requires=["numpy==1.23.4", "astroquery==0.4.6", "pandas==1.5.1", "astropy==5.1.1", "packaging==21.3",
                      "tqdm==4.64.1", "exceptiongroup==1.0.4", "scipy==1.1.0", "tabulate==0.9.0"],
