...
#  Last modified by David J Turner (turne540@msu.edu) 24/04/2024, 14:35. Copyright (c) The Contributors
...
arch = Archive("PHL1811_made_earlier", [xm, ch, nu, ra], clobber=True, use_preprocessed={'xmm_pointed': False,
                                                                                         'chandra': True,
                                                                                         'nustar_pointed': True, 
                                                                                         'rosat_all_sky': True})
