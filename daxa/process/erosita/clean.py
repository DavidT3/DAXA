...
#  Last modified by David J Turner (turne540@msu.edu) 23/04/2024, 16:33. Copyright (c) The Contributors
import os
...
def flaregti(obs_archive: Archive, pimin: Quantity = Quantity(200, 'eV'), pimax: Quantity = Quantity(10000, 'eV'),
    ...
    flaregti_cmd = "cd {d}; ln -s {ef} {lef}; flaregti eventfile={lef} pimin={pimi} pimax={pima} " \
                   ...
                   "write_lightcurve={wl} lightcurve={lcf} write_thresholdimg={wti} thresholdimg={tif} gti_file=el_testo.fits; " \
    ...
    for miss in erosita_miss:
        ...
        for obs_id in obs_info_dict:
            ...
            # "images/obsid{oi}-inst{i}-subexp{se}-en{l}_{h}keV-image.fits"
