...
#  Last modified by David J Turner (turne540@msu.edu) 28/03/2023, 16:43. Copyright (c) The Contributors
...
def parse_odf_sum(sum_path: str):
    ...
    # inst_sec_parser(inst_secs['M1'], 'M1')
    # inst_sec_parser(inst_secs['M2'], 'M2')
    inst_sec_parser(inst_secs['R1'], 'R1')
    # inst_sec_parser(inst_secs['R2'], 'R2')
