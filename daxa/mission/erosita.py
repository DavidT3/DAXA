...
#  Last modified by David J Turner (turne540@msu.edu) 01/03/2024, 13:55. Copyright (c) The Contributors
...
class eROSITACalPV(BaseMission):
    ...
    def _check_chos_insts(self, insts: Union[List[str], str]):
        ...
        This subclass of BaseMission re-implements this method so that setting chosen instruments also
